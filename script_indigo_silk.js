...
function initChart(labels, dataValue) {
    ...
    chartInstance = new Chart(ctx, {
        type: 'radar', // Radar chart for spicy profile mapping!
        data: {
            labels: labels,
            datasets: [{
                label: 'Total Items Ordered',
                data: dataValue,
                backgroundColor: 'rgba(255, 89, 94, 0.2)', // Chili red transparent
                borderColor: '#FF595E', // Chili red border
                pointBackgroundColor: '#8AC926', // Lime green points
                pointBorderColor: '#fff',
                pointHoverBackgroundColor: '#fff',
                pointHoverBorderColor: '#8AC926',
                borderWidth: 2
            }]
        },
        options: {
