...
function initChart(labels, dataValue) {
    ...
    chartInstance = new Chart(ctx, {
        type: 'line', // Let's use a Line chart for Seoul Night
        data: {
            labels: labels,
            datasets: [{
                label: 'Total Items Ordered',
                data: dataValue,
                backgroundColor: 'rgba(255, 0, 84, 0.2)', // Pink with opacity
                borderColor: '#FF0054', // Neon pink edge
                pointBackgroundColor: '#FFD60A', // Yellow dots
                borderWidth: 3,
                fill: true,
                tension: 0.3
            }]
